  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = ((-u_xlat10_0.xyz) + float3(1, 1, 1));
          u_xlat1_d.xyz = (u_xlat16_1.xyz * _Black.xyz);
          u_xlat1_d.xyz = (u_xlat10_0.www * u_xlat1_d.xyz);
          u_xlat1_d.xyz = (u_xlat1_d.xyz * _Color.www);
